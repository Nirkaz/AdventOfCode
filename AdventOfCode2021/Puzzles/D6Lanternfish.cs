...
public static class D6Lanternfish
{
    public static long SolvePart1(string[]? customInput = null)
    {
        var fishes = Array
            .ConvertAll(customInput ?? PuzzleInput.GetFromFileAsStrings("PuzzleInputD6.txt").First().Split(','),
                int.Parse).ToList();
        var days = 80;
    ...
    public static long SolvePart2(string[]? customInput = null)
    {
        ...
        return countZero + countOne + countTwo + countThree + countFour + countFive + countSix + countSeven +
               countEight;
    }
}
